...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($title_err) && empty($content_err)) {
        $sql = "UPDATE BlogPosts SET title = ?, content = ? WHERE id = ?";
...
<head>
    ...
    <title>Edit Blog Post - Lawyer Booking App</title>
...
<div class="container mt-4">
    ...
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]) . "?id=" . $post_id; ?>" method="post">
        ...
        <div class="mb-3">
            ...
            <a href="blog_post.php?id=<?php echo $post_id; ?>" class="btn btn-secondary">Cancel</a>
        </div>
    </form>
</div>
